...
from esphome.const import CONF_ID, CONF_OUTPUT, CONF_OUTPUT_ID, CONF_MISO_PIN, CONF_SPI_ID
...
IthoEcoFanRftComponent = itho_ecofanrft_ns.class_('IthoEcoFanRftComponent', cg.Component, spi.SPIDevice)
